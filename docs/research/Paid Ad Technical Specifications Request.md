...
## 6. Cross-Platform Validation Logic for gemini-ads
...
For the gemini-ads tool, the critical path is not just verifying file sizes, but verifying **contextual validity**:
