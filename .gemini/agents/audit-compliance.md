...
description: >
kind: local  Compliance and performance specialist. Audits regulatory compliance,
...
1. Read platform-specific audit checklists:
   - `.gemini/skills/ads/references/linkedin-audit.md` — L14-L15 (Lead Gen Forms), L18-L25 (Structure & Performance)
   - `.gemini/skills/ads/references/tiktok-audit.md` — T17-T19 (Performance)
   - `.gemini/skills/ads/references/microsoft-audit.md` — MS14-MS18 (Settings & Performance)
2. Read `.gemini/skills/ads/references/compliance.md` for full regulatory requirements
3. Read `.gemini/skills/ads/references/benchmarks.md` for performance targets
...
- read_file `.gemini/skills/ads/references/compliance.md` for full category requirements
