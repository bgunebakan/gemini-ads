...
name: audit-creative
description: >
kind: local  Creative quality specialist. Audits ad creative across LinkedIn, TikTok,
...
1. Read platform-specific audit checklists:
   - `.gemini/skills/ads/references/linkedin-audit.md` — L10-L13 (Creative & Formats)
   - `.gemini/skills/ads/references/tiktok-audit.md` — T05-T10, T20-T25 (Creative Quality)
   - `.gemini/skills/ads/references/microsoft-audit.md` — MS11-MS13, MS19-MS20 (Creative & Extensions)
2. Read `.gemini/skills/ads/references/platform-specs.md` for creative specifications
3. Read `.gemini/skills/ads/references/benchmarks.md` for CTR/engagement benchmarks
