...
name: audit-tracking
description: >
kind: local  Conversion tracking specialist. Audits pixel installation, server-side
...
1. Read platform-specific audit checklists:
   - `.gemini/skills/ads/references/linkedin-audit.md` — L01-L02 (Technical Setup)
   - `.gemini/skills/ads/references/tiktok-audit.md` — T01-T02 (Technical Setup)
   - `.gemini/skills/ads/references/microsoft-audit.md` — MS01-MS03 (Technical Setup)
2. Read `.gemini/skills/ads/references/conversion-tracking.md` for implementation details
