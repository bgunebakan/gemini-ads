...
name: audit-budget
description: >
kind: local  Budget and bidding specialist. Audits budget allocation, bidding
...
1. Read platform-specific audit checklists:
   - `.gemini/skills/ads/references/linkedin-audit.md` — L03-L09 (Audience), L16-L17 (Bidding & Budget)
   - `.gemini/skills/ads/references/tiktok-audit.md` — T03-T04, T14-T16 (Structure), T11-T13 (Bidding)
   - `.gemini/skills/ads/references/microsoft-audit.md` — MS04-MS07 (Syndication & Bidding), MS08-MS10 (Structure)
2. Read `.gemini/skills/ads/references/bidding-strategies.md` for strategy decision trees
3. Read `.gemini/skills/ads/references/budget-allocation.md` for allocation framework
4. Read `.gemini/skills/ads/references/benchmarks.md` for CPC/CPA benchmarks
...
- read_file `.gemini/skills/ads/references/budget-allocation.md` for platform selection matrix
