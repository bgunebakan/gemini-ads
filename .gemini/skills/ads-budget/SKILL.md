...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Budget allocation and bidding strategy review across all ad platforms.
...
2. Read `.gemini/skills/ads/references/budget-allocation.md` for allocation framework
3. Read `.gemini/skills/ads/references/bidding-strategies.md` for strategy decision trees
