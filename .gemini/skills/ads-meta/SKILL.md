...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Meta Ads deep analysis covering Facebook and Instagram advertising.
...
2. Read `.gemini/skills/ads/references/meta-audit.md` for full 46-check audit
3. Read `.gemini/skills/ads/references/benchmarks.md` for Meta-specific benchmarks
4. Read `.gemini/skills/ads/references/scoring-system.md` for weighted scoring
