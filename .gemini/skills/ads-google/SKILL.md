...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Google Ads deep analysis covering Search, Performance Max, Display, YouTube,
...
2. Read `.gemini/skills/ads/references/google-audit.md` for full 74-check audit
3. Read `.gemini/skills/ads/references/benchmarks.md` for Google-specific benchmarks
