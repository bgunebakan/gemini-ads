...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  TikTok Ads deep analysis covering creative quality, tracking, bidding,
...
2. Read `.gemini/skills/ads/references/tiktok-audit.md` for full 25-check audit
3. Read `.gemini/skills/ads/references/benchmarks.md` for TikTok-specific benchmarks
4. Read `.gemini/skills/ads/references/platform-specs.md` for creative specifications
5. Read `.gemini/skills/ads/references/scoring-system.md` for weighted scoring algorithm
