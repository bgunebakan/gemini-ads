...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Comprehensive paid advertising audit and optimization for any business type.
...
**Path resolution:** All references are installed at `.gemini/skills/.gemini/skills/ads/references/`.
When sub-skills or agents reference `.gemini/skills/ads/references/*.md`, resolve to
`.gemini/skills/.gemini/skills/ads/references/*.md`.
