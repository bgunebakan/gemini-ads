...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Strategic paid advertising planning with industry-specific templates.
...
- read_file `.gemini/skills/ads/references/conversion-tracking.md` for tracking setup requirements
...
Read `.gemini/skills/ads/references/budget-allocation.md` for the 70/20/10 framework.
