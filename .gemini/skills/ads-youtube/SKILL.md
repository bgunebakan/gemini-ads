...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  YouTube Ads specific analysis covering campaign types, creative quality,
...
2. Read `.gemini/skills/ads/references/google-audit.md` for YouTube-relevant checks
3. Read `.gemini/skills/ads/references/platform-specs.md` for video specifications
4. Read `.gemini/skills/ads/references/benchmarks.md` for YouTube benchmarks
5. Read `.gemini/skills/ads/references/scoring-system.md` for health score algorithm
...
Weighted assessment from `.gemini/skills/ads/references/scoring-system.md`:
