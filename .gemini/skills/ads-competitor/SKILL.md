...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Competitor ad intelligence analysis across Google, Meta, LinkedIn, TikTok,
...
2. Read `.gemini/skills/ads/references/benchmarks.md` for industry CPC/CTR/CVR baselines
