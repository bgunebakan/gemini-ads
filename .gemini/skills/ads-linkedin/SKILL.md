...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  LinkedIn Ads deep analysis for B2B advertising. Evaluates 25 checks across
...
2. Read `.gemini/skills/ads/references/linkedin-audit.md` for full 25-check audit
3. Read `.gemini/skills/ads/references/benchmarks.md` for LinkedIn-specific benchmarks
