...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Microsoft/Bing Ads deep analysis covering search, Performance Max, Audience
...
2. Read `.gemini/skills/ads/references/microsoft-audit.md` for full 20-check audit
3. Read `.gemini/skills/ads/references/benchmarks.md` for Microsoft-specific benchmarks
