...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Full multi-platform paid advertising audit with parallel subagent delegation.
...
Read `.gemini/skills/ads/references/scoring-system.md` for full algorithm.
