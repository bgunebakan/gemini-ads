...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Landing page quality assessment for paid advertising campaigns. Evaluates
...
2. Read `.gemini/skills/ads/references/benchmarks.md` for conversion rate benchmarks
3. Read `.gemini/skills/ads/references/conversion-tracking.md` for pixel/tag verification
