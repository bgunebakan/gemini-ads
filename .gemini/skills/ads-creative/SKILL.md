...
allowed-tools:
  ...
  - run_shell_command
  - web_fetch
  - write_file  Cross-platform creative quality audit covering ad copy, video, image, and
...
4. Read `.gemini/skills/ads/references/scoring-system.md` for weighted scoring algorithm
